...
const eventSummary = 'Example Event';
const eventLocation = 'Virtual';
const eventDescription = 'This is an example event description';
const eventStartDate = '2023-03-17T12:00:00+03:00';
const eventEndDate = '2023-03-17T16:00:00+03:00';
const eventTimeZone = 'America/Los_Angeles';

// Define variables with placeholders for email details
const emailSubject = 'Example Event Invitation';
const emailBody = `Event Summary: ${eventSummary}
